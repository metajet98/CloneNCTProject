...
var whoosh;
export default class SongPlayer extends Component<Props> {
	...
	{	
		...
		this.setState({
			mp3Source:this.props.mp3Source,
		  	avatar:this.props.item.avatar,
		  	title:this.props.item.title,
		  	singer_name:this.props.item.singer_name,
		  	currentTime:0,
		  	duration:0,
		});
	...
	onPressStart()
	{	
		if(this.state.mp3Source!=''&&!(typeof whoosh === "undefined"))
		{
			this.TimerTest();
